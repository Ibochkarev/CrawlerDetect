...
через свойства сниппета (placeholderPrefix).
...
Документация
================================================================================
- Руководство пользователя (установка, сценарии, FAQ) — docs/user-guide.md
- API (спецификация сниппетов, параметры, примеры) — docs/api.md
